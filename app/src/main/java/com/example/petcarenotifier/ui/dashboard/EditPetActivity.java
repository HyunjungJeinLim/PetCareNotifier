...
public class EditPetActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (uri != null) {
                try {
                    // ✅ Only pass valid flags for takePersistableUriPermission
                    ...
                    e.printStackTrace();
                    Toast.makeText(this, "Permission error: can't persist URI.", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
